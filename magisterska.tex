...
W pierwszym rozdziale zawarłam teoretyczne fundamenty Satisfiability Modulo Theories(SMT), wprowadzając czytelnika w główne aspekty tej dziedziny. Rozdział zaczyna się od ogólnej wypowiedzi na temat SMT, rzucając światło na kluczowe pojęcia, w tym czasie jak historia i rozwój SMT-solverów przedstawiają kontekst ewolucji tych narzędzi. 
%Podstawowe teorie logiczne są omówione w kontekście ich roli w problemach NP-trudnych, a zastosowanie SMT w praktyce przedstawia konkretny obraz wykorzystania teoretycznych fundamentów w rzeczywistych zastosowaniach.

Drugi rozdział przedstawia podstawowe pojęcia złożoności obliczeniowej oraz koncepcji spełnialności, dwóch kluczowych aspektów niezbędnych do zrozumienia, czym są problemy NP-trudne w kontekście SMT. Następnie dokonywana jest definicja klasy problemów NP-trudnych, które stanowią centralny temat niniejszej pracy magisterskiej.
