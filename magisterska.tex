...
Przedmiotem badań będą klasyczne problemy NP-trudne, a celem jest zbadanie i porównanie efektywności SMT solverów Pythona - Z3, Yices i CVC5 - w kontekście rozwiązywania wyżej wymienionych problemów. Wybór tych konkretnych narzędzi wynika z ich popularności, wszechstronności i aktywnego udziału w społeczności badawczej.
...
Rozdział drugi przedstawia obszerny przegląd literatury z zakresu SMT solverów oraz problemów NP-trudnych. Poprzez analizę wcześniejszych badań, podkreślam istotne osiągnięcia oraz ewentualne luki w dotychczasowym rozumieniu tej dziedziny, co stanowi podstawę dla dalszej analizy i eksperymentów.
...
Rozdział czwarty poświęcony jest praktycznym eksperymentom, wykorzystując Z3, Yices i CVC5 do rozwiązania konkretnych problemów NP-trudnych. Analiza wyników pozwoli określić efektywność poszczególnych solverów i wyciągnąc wnioski co do ich zastosowania.
