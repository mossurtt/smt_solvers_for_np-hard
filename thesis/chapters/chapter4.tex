...
\lstinputlisting[caption={Czytanie grafu z pliku}]{../experiments/utils/read_graph_from_file.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Czytanie skierowanego grafu z pliku}]{../experiments/utils/read_digraph_from_file.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Czytanie grafu z wagami}]{../experiments/utils/read_wgraph_from_file.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Czytanie zbioru z pliku}]{../experiments/utils/read_set_from_file.py}
\vspace{1cm}
...
\lstinputlisting[caption={Przypisanie właściwych wartości}]{../experiments/utils/proper_numbers.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Unikalne wartości}]{../experiments/utils/distinct_vs.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Krawędź skierowana}]{../experiments/utils/dir_edge.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Krawędź nieskierowana}]{../experiments/utils/edge.py}
\vspace{0.5cm}
...
\lstinputlisting[caption={Krawędź etykietowana}]{../experiments/utils/wedge.py}
...
\lstinputlisting[caption={Program $\hampath$}]{../experiments/1_Sciezka_Hamiltona_w_grafie_skierowanym/hampath.py}
...
\lstinputlisting[caption={Program $\maxclique$}]{../experiments/3_Maksymalna_klika/maxclique.py}
...
\lstinputlisting[caption={Program $\maxindset$}]{../experiments/4_Maksymalny_niezalezny_zbior/maxindset.py}
...
\lstinputlisting[caption={Program $\graphcoloring$}]{../experiments/6_Kolorowanie_grafu/graph_coloring.py}
...
\lstinputlisting[caption={Program $\tsp$}]{../experiments/7_Problem_Komiwojazera/tsp.py}
...
\lstinputlisting[caption={Program $\subsetsum$}]{../experiments/8_Problem_sumy_podzbioru/subsetsum.py}
