...
\az{Aby zakodować problem decyzyjny czy graf ma pokrycie o rozmiarze $k$ użyjemy $k$ zmiennych $v_0,\ldots,v_{k-1}$,
gdzie $0 < k \leq n$.}
...
\az{Poniższe zdanie nie jest prawdą}
...
\az{Druga część formuły gwarantuje, że dla każdej krawędzi w $E$ co najmniej jeden z jej końców należy do $V'$.}

\az{Należy zmienić drugą część formuły zgodnie z powyższym zdaniem.}
