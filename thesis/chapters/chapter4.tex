...
\lstinputlisting[caption={Program $\hampath$}]{../experiments/Sciezka_Hamiltona_w_grafie_skierowanym/hampath.py}
...
\lstinputlisting[caption={Program $\maxclique$}]{../experiments/Maksymalna_klika/maxclique.py}
...
\lstinputlisting[caption={Program $\maxindset$}]{../experiments/Maksymalny_niezalezny_zbior/maxindset.py}
...
\lstinputlisting[caption={Program $\graphcoloring$}]{../experiments/Kolorowanie_grafu/graph_coloring.py}
...
\lstinputlisting[caption={Program $\tsp$}]{../experiments/Problem_Komiwojazera/tsp.py}
...
\lstinputlisting[caption={Program $\subsetsum$}]{../experiments/Problem_sumy_podzbioru/subsetsum.py}
